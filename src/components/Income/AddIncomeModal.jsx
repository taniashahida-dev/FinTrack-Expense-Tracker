...
>
  <ListBox className="p-1 outline-none w-full">
    ...
    <ListBox.Item id="Salary" textValue="Salary" className="p-2.5 hover:bg-[#222642] focus:bg-[#222642] cursor-pointer rounded outline-none block text-white font-medium">
      Salary
    </ListBox.Item>
    <ListBox.Item id="Freelancing" textValue="Freelancing" className="p-2.5 hover:bg-[#222642] focus:bg-[#222642] cursor-pointer rounded outline-none block text-white font-medium">
      Freelancing
    </ListBox.Item>
    <ListBox.Item id="Investment" textValue="Investment" className="p-2.5 hover:bg-[#222642] focus:bg-[#222642] cursor-pointer rounded outline-none block text-white font-medium">
      Investment
    </ListBox.Item>
    <ListBox.Item id="Business" textValue="Business" className="p-2.5 hover:bg-[#222642] focus:bg-[#222642] cursor-pointer rounded outline-none block text-white font-medium">
      Business
    </ListBox.Item>
    <ListBox.Item id="Rental" textValue="Rental" className="p-2.5 hover:bg-[#222642] focus:bg-[#222642] cursor-pointer rounded outline-none block text-white font-medium">
      Rental
    </ListBox.Item>
    <ListBox.Item id="Others" textValue="Others" className="p-2.5 hover:bg-[#222642] focus:bg-[#222642] cursor-pointer rounded outline-none block text-white font-medium">
      Others
    </ListBox.Item>
  </ListBox>
</Select.Popover>
