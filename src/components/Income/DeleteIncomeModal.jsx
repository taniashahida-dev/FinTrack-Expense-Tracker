...
export default function DeleteIncomeModal({
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const res = await deleteIncome(incomeId, userEmail);
      ...
      <div className="bg-[#121424] border border-gray-800 text-white rounded-2xl w-full max-w-sm overflow-hidden shadow-2xl relative p-6 text-center flex flex-col items-center gap-4 animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className=" flex justify-center gap-3 w-full mt-2">
          <Button
            type="button"
            onPress={onClose}
            className="bg-transparent border border-gray-700 text-gray-400 rounded-xl py-2.5"
          >
            Cancel
          </Button>
          ...
          <Button
            ...
            className="bg-[#F43F5E] text-white font-semibold rounded-xl py-2.5 shadow-lg shadow-red-500/20"
          >
            Delete
          </Button>
        </div>
